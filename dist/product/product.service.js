    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    connection.query("Select distinct category from Product", function (err, res) {
                        if (err) {
                            reject(err);
                        }
                        resolve(res);
...
function GetSingleProduct(connection, id) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, new Promise(function (resolve, reject) {
